...
export const CLASS_COLORS: Record<string, string> = {
  Wizard: '#7c3aed',     // purple — controllers
  Sorcerer: '#dc2626',   // crimson — volume scorers
  Warlock: '#9333ea',    // violet — high-variance gunners
  ...
  Cleric: '#f59e0b',     // amber — glue
  Druid: '#15803d',      // forest — stretch bigs
  Rogue: '#64748b',      // slate — event creators
  Fighter: '#737373',    // neutral — balanced
};

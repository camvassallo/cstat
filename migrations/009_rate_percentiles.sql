...
ALTER TABLE player_percentiles ADD COLUMN IF NOT EXISTS mpg_pct DOUBLE PRECISION;
ALTER TABLE player_percentiles ADD COLUMN IF NOT EXISTS topg_pct DOUBLE PRECISION;

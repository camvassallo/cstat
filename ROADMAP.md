...
- [x] **Roster fit scoring built on archetypes — investigated and intentionally reverted** *(2026-05-27)*. The chip shipped v1 then v2, and the underlying "balance is good, density is bad" prior was then empirically invalidated. See `docs/archetype_balance_finding.md`.
